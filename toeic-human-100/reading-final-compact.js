/* Final reading-length guard for TOEIC HUMAN V1.
   Runs after all reading sources/patches and guarantees the visible program
   is normalized to the 500~650-word focused-reading target. */
(function (root) {
  'use strict';
  ...
  function compressParagraphs(paragraphs) {
    ...
    /* Fallback: if every paragraph is down to one sentence and the text is
       still too long, remove interior paragraphs while preserving opening
       and conclusion. */
    safety = 0;
  ...
  function normalizeDay(day) {
    ...
    day.coverage.finalCompactGuard = true;
    return day;
  }
