...
const report = {
  ...
  generatedVocabularyRange:generated.length ? {min:Math.min(...generated.map(x=>x.vocabCount)),max:Math.max(...generated.map(x=>x.vocabCount))} : null,
...
console.log(JSON.stringify({daysValidated:report.daysValidated,generatedDays:report.generatedDays,generatedWordRange:report.generatedWordRange,generatedVocabularyRange:report.generatedVocabularyRange,errorCount:errors.length,errors:errors.slice(0,30)},null,2));
