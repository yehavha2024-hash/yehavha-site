(() => {
  ...
  Object.assign(window.LEGAL_PHILOSOPHY_CITATIONS, {
    aristotle:entry({
      ...
      opposition:row('Guido Calabresi, The Costs of Accidents (Yale UP, 1970).','사법책임을 사고비용 최소화와 위험배분으로 분석하는 경쟁축.'),
    ...
    aquinas:entry({
      primary:[row('Thomas Aquinas, Summa Theologiae, I–II, q. 90, aa. 1–4.','법의 본질을 이성·공공선·정당한 권위·공포의 요소로 분석. q./a. 표기를 기준으로 인용.','https://www.newadvent.org/summa/2090.htm'),row('Thomas Aquinas, Summa Theologiae, I–II, q. 94; q. 96.','q.94 자연법, q.96 인간법의 범위와 한계.')],
    ...
    bentham:entry({
      primary:row('Jeremy Bentham, An Introduction to the Principles of Morals and Legislation, Ch. I, especially §§I–IV.','효용원칙을 제도·행위 평가의 출발점으로 제시. 장·절 표기를 우선.','https://oll.libertyfund.org/titles/bentham-an-introduction-to-the-principles-of-morals-and-legislation'),
      followUp:row('Guido Calabresi, The Costs of Accidents (Yale UP, 1970).','사고비용·예방비용·제도비용을 결합한 현대 위험배분론.'),
    ...
    finnis:entry({
      primary:row('John Finnis, Natural Law and Natural Rights, 2nd ed. (OUP, 2011), Chs. III–VI.','초판 기준 Ch. III p. 59, Ch. IV p. 81, Ch. V p. 100, Ch. VI p. 134부터. basic goods·practical reasonableness·community/common good의 핵심 구간.','https://books.google.com/books/about/Natural_Law_and_Natural_Rights.html?id=zHBCAgAAQBAJ'),
    ...
    barak:entry({
      status:'인용검증 완료 · 직접 인용 가능',
      quoteVerification:quote('직접 인용 가능','Proportionality Ch. 6 pp. 131–174 및 요소별 Chs. 9–12의 공식 Cambridge 원문/목차 위치가 확인되어 구조적 명제는 직접 인용 가능하다.','Cambridge Core 공식 장 PDF와 장별 위치 확인.'),
      primary:[row('Aharon Barak, Proportionality: Constitutional Rights and their Limitations (CUP, 2012), Ch. 6, pp. 131–174.','proper purpose, rational connection, necessity, proportionality stricto sensu의 전체 구조.','https://www.cambridge.org/core/services/aop-cambridge-core/content/view/5D27E24EBDCE307FE5DF0F7550508B3F/9781139035293c6_p131-174_CBO.pdf/the-nature-and-function-of-proportionality.pdf'),row('Aharon Barak, Proportionality, Chs. 9–12.','Ch. 9 proper purpose는 pp. 245–302에서 시작하고 이후 합리적 관련성·필요성·협의의 비례성을 요소별로 분리.','https://www.cambridge.org/core/books/abs/proportionality/proper-purpose/6384B427CF786331C75B2B177EFE0A7E')],
    ...
    weinrib:entry({
      ...
      quoteVerification:quote('위치 확인','The Idea of Private Law Ch. 3 pp. 56–83, Ch. 5 p. 114 이하의 공식 위치는 확인됨. 직접 문장은 OUP 사용판본 원문에서 최종 확인한다.','출판사 공식 목차·장·쪽수는 확인되었으나 본문 전체 접근이 제한됨.'),
      primary:row('Ernest J. Weinrib, The Idea of Private Law, 2nd ed. (OUP, 2012), Ch. 3 “Corrective Justice,” pp. 56–83; Ch. 5 “Correlativity,” beginning p. 114.','원고와 피고의 상관적 규범지위와 교정적 정의를 검토하는 핵심 위치.','https://academic.oup.com/book/4099/chapter-abstract/145815769'),
      ...
      opposition:row('Guido Calabresi, The Costs of Accidents (Yale UP, 1970).','사회적 효율·위험배분 중심의 도구주의적 대립축.'),
    ...
    schauer:entry({
      primary:[row('Frederick Schauer, Playing by the Rules (OUP, 1991), Ch. 2 “Rules as Generalizations,” pp. 17–37.','§2.7의 under- and over-inclusiveness를 포함한 규칙 일반화 논증.','https://academic.oup.com/book/4020/chapter-abstract/145660096'),row('Frederick Schauer, Playing by the Rules, Ch. 3 “The Entrenchment of Generalizations,” pp. 38–52.','규칙 일반화가 독립된 결정이유가 되는 구조.','https://academic.oup.com/book/4020/chapter-abstract/145660991')],
    ...
    'haeberle-open-society':entry({
      status:'인용검증 완료 · 위치 확인',
      quoteVerification:quote('위치 확인','독일 원논문은 JuristenZeitung 1975, pp. 297–305로 서지가 확인됨. 독일어 직접 인용은 원 JZ 판본을 최종 대조한다.','원출전·페이지와 번역본 내용은 확인되었으나 독일어 원문 직접 대조가 남음.'),
      primary:row('Peter Häberle, “Die offene Gesellschaft der Verfassungsinterpreten,” JuristenZeitung (1975), pp. 297–305.','국가기관 밖 시민·집단 등 다양한 해석주체를 포함하는 열린 헌법해석사회 논증의 원출전.','https://repositoriosdigitales.sicyt.gob.ar/vufind/Record/RDIUBA_cef6b5bf11575e4e02e7b6acb3bbd686'),
    ...
    'fletcher-reciprocity':entry({
      ...
      opposition:row('Guido Calabresi, The Costs of Accidents (Yale UP, 1970).','사고비용 최소화와 효율적 위험배분의 경쟁축.'),
    ...
    'gunkel-robot-rights':entry({
      ...
      followUp:row('Abeba Birhane & Jelle van Dijk, “Robot Rights? Let’s Talk about Human Welfare Instead” (2020).','robot rights보다 실제 인간복지·책임 문제를 우선하는 비판적 후속논의.','https://arxiv.org/abs/2001.05046'),
