(function(){
  ...
  patch('civil-apparent-agency',{
    ...
    caseOfficialUrl:'https://www.law.go.kr/LSW/precInfoP.do?precSeq=606763',caseOriginalChecked:true
  });
  ...
  patch('civil-superficies',{
    ...
    caseOfficialUrl:'https://law.go.kr/LSW/precInfoP.do?precSeq=191093',caseOriginalChecked:true
  });
  ...
  patch('commercial-director-duty',{
    ...
    caseOfficialUrl:'https://law.go.kr/LSW/precInfoP.do?precSeq=234447',caseOriginalChecked:true
  });
  ...
  patch('criminal-dolus-eventualis',{
    ...
    caseOfficialUrl:'https://www.scourt.go.kr/portal/news/NewsViewAction.work?gubun=4&seqnum=10054',caseOriginalChecked:true
  });
  ...
  patch('ip-inventive-step',{
    ...
    caseOfficialUrl:'https://www.law.go.kr/LSW/precInfoP.do?mode=0&precSeq=208793',caseOriginalChecked:true
  });
  ...
  patch('ip-trademark-similarity',{
    ...
    caseOfficialUrl:'https://www.law.go.kr/LSW/precInfoP.do?precSeq=226289',caseOriginalChecked:true
  });
  ...
  patch('ip-design-similarity',{
    ...
    caseOfficialUrl:'https://law.go.kr/LSW/precInfoP.do?mode=0&precSeq=214413',caseOriginalChecked:true
  });
})();