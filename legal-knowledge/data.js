...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const duplicateResolution = document.createElement('script');
  duplicateResolution.src = 'data-duplicate-id-resolution-20260809.js';
  duplicateResolution.onload = () => {
            ...
            dedupData.onload = () => {
              ...
              sourceHotfix.onload = () => {
                ...
                manualSourceReview.onload = () => {
                  const manualArticleReview = document.createElement('script');
                  manualArticleReview.src = 'data-article-manual-review-round2-20260809.js';
                  manualArticleReview.onload = () => {
                  ...
                  document.body.appendChild(manualArticleReview);
                };
  ...
  document.body.appendChild(duplicateResolution);
});
