...
- AI·디지털 전환에서 반드시 숙지할 핵심 법령은 동일한 전문 기준으로 추가합니다. 2026-08-07 기준 AI 법제 36개를 추가한 85개 구조에 2026-08-09 핵심 법리 20개와 2026-08-12 민사법 핵심 판례·법리 2개를 추가하여 총 107개 연구항목 구조입니다.
...
- `data-core-expansion-20.js` : 2026-08-09 추가한 핵심 법리 20개(민사 6·공법 4·형사 4·지식재산 3·조세/전문법 3)
- `data-daily-briefing-20260812.js` : 계약금 해제·이행의 착수와 기판력의 변론종결 뒤 승계인 법리 2개

AI·디지털 법제 확장:

- `data-ai-foundation.js` : 헌법·인공지능기본법·행정자동화·국가 디지털 거버넌스
- `data-ai-foundation-advanced.js` : 인공지능기본법 제32조 최첨단 AI 안전성 및 2027 시행예정 공공분야 AI 영향평가
...
AI 법제는 개별법 하나에 고립시키지 않고 관련 민사책임·공법·데이터·산업안전·지식재산 규율을 교차 연결합니다. 시행예정 법령은 현행 의무와 구별하여 시행일을 명시합니다.
