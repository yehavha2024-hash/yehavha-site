...
const verified={
 ...
 'CORE-102-L01':V(['Aristotle, Prior Analytics; Loeb Classical Library 325, 1938'],'Prior Analytics의 syllogism/premise 원전 범위 확인.'),
 'CORE-102-L02':V(['Alfred Tarski, Introduction to Logic and to the Methodology of the Deductive Sciences, 4th ed., 1994'],'OUP 판본의 정확한 제목과 deductive logic 범위 확인.'),
 'CORE-102-L03':V(['Patrick J. Hurley, A Concise Introduction to Logic, 14th ed., 2024'],'Cengage 현행 판본과 validity/soundness 기본논리 범위 확인.'),
 'CORE-102-L04':V(['Frederic B. Fitch, Symbolic Logic: An Introduction, 1952'],'Ronald Press 1952 서지와 formal proof/natural deduction 관련성 확인.'),
 'CORE-102-L05':V(['Gottlob Frege, Begriffsschrift, Louis Nebert, 1879'],'Frege 1879 원전 서지와 형식언어·양화논리의 역사적 출발점 확인.'),
 'CORE-102-L06':V(['W. V. O. Quine, Methods of Logic, 4th ed., 1982'],'Harvard University Press 4판 서지 확인.'),
 'CORE-102-L07':V(['Ian Hacking, An Introduction to Probability and Inductive Logic, 2001'],'Cambridge 교재의 Bayes rule·induction·probability 범위 확인.'),
 'CORE-102-L08':V(['Gilbert H. Harman, “The Inference to the Best Explanation,” The Philosophical Review 74(1), 1965, 88–95.'],'IBE의 원 논문 서지와 abduction/설명추론 주제 적합성 확인.'),
 'CORE-102-L09':V(['Copi, Cohen & McMahon, Introduction to Logic, 14th ed., 2011'],'Routledge 목차의 fallacies·deduction 범위 확인.'),
 'CORE-102-L10':V(['Stephen E. Toulmin, The Uses of Argument, 2nd ed., 2003'],'Cambridge 판본 ch. III The Layout of Arguments 확인.'),
 'CORE-102-L11':V(['H. P. Grice, “Logic and Conversation,” Syntax and Semantics 3, 1975, 41–58.'],'1975 편집서 수록 정보와 implicature/context 주제 적합성 확인.'),
 'CORE-102-L12':V(['Alfred Tarski, Introduction to Logic and to the Methodology of the Deductive Sciences, 4th ed., 1994','Patrick J. Hurley, A Concise Introduction to Logic, 14th ed., 2024'],'종합논리 분석에 사용할 표준교재 서지 확인.')
};
window.NEXUS_QA_REGISTER={version:'1.2',updated:'2026-08-20',totalCourses:496,totalLessons:5952,
 ...
 batches:[
  {id:'QA-01',title:'University Core',courses:35,lessons:420,status:'ACTIVE · 24/420 SOURCE PASS',scope:'대표문헌·원전·공식·기초개념의 기준점 확정'},
 ...
 revised:{
  ...
  'CORE-102-L02':{date:'2026-08-20',reason:'Tarski 저서 제목 축약',change:'Introduction to Logic and to the Methodology of the Deductive Sciences로 정규화.'},
  'CORE-102-L08':{date:'2026-08-20',reason:'Harman 저작의 문헌형식 불명확',change:'The Philosophical Review 74(1), 1965, 88–95 논문으로 정규화.'},
  'CORE-102-L11':{date:'2026-08-20',reason:'Grice 저작의 수록정보 누락',change:'Syntax and Semantics Vol. 3, 1975, 41–58로 정규화.'}
 },notes:{'CORE-101':{status:'FIRST_PASS_SOURCE_ALIGNMENT_COMPLETE',next:'강의본문의 개별 사실명제·공식 해설·평가문항을 2차 세부검증'},'CORE-102':{status:'FIRST_PASS_BIBLIOGRAPHY_COMPLETE',next:'논리기호·추론규칙·용어정의의 세부검증'}}};
})();