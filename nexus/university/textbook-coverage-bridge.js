...
const tracks={
  ...
  economics:['기본 개념과 가정','가격·인센티브·의사결정','변수와 회계관계','모형과 균형','자료와 측정','계산·추정 방법','시장·기업 대표사례','위험과 불확실성','경쟁모형·민감도','정책·경영 적용','디지털경제·핀테크·AI','종합 의사결정'],
...
const domainMethod={
  ...
  economics:'가정·가격·인센티브·모형·자료·추정·위험을 구분하고 정량결과를 실제 경제·경영 의사결정과 연결한다',
